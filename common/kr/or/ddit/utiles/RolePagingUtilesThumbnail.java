...
public class RolePagingUtilesThumbnail {
   private int currentPage;   // 현재 페이지 번호
   private int totalCount;      // 전체 게시글 수
   private int totalPage;      // 전체 페이지 수
   private int blockCount = 4;// 페이지별 출력될 게시글 수
   ...
   public RolePagingUtilesThumbnail(int currentPage, int totalCount, HttpServletRequest request){
