...
<script type="text/javascript">
	$(function() {
		...
		$('#delete').click(function() {
			var url = '${pageContext.request.contextPath}/user/member/deleteMember.do?mem_id=${LOGIN_MEMBERINFO.mem_id}';
...
<body>
	...
	<div class="col-md-9">
        <form action="#" class="form-horizontal"><h3>계정 정보</h3>
        	...
        	<input type="hidden" id="mem_name" name="mem_name" value="${memberInfo.mem_name }"/>

            <div class="form-group"><label class="col-sm-3 control-label">이메일</label>
                <div class="col-sm-9 controls">
                    <div class="row">
                        <div class="col-xs-9"><input type="text" value="${memberInfo.mem_mail }" id="mem_mail" name="mem_mail" placeholder="test@test.com" class="form-control"/></div>
                    </div>
                </div>
            </div>
            <div class="form-group"><label class="col-sm-3 control-label">닉네임</label>
                <div class="col-sm-9 controls">
                    <div class="row">
                        <div class="col-xs-9"><input type="text" value="${memberInfo.mem_nick }" id="mem_nick" name="mem_nick" class="form-control"/></div>
                    </div>
                </div>
            </div>
            <div class="form-group"><label class="col-sm-3 control-label">비밀번호</label>
                <div class="col-sm-9 controls">
                    <div class="row">
                        <div class="col-xs-4"><input type="password" value="${memberInfo.mem_pass }"id="mem_pass" name="mem_pass" class="form-control"/></div>
                    </div>
                </div>
            </div>
            <div class="form-group"><label class="col-sm-3 control-label">비밀번호 확인</label>
                <div class="col-sm-9 controls">
                    <div class="row">
                        <div class="col-xs-4"><input type="password" id="mem_passChk" name="mem_passchk" class="form-control"/></div>
                    </div>
                </div>
            </div>
            <hr/>
            ...
            <div class="form-group"><label class="col-sm-3 control-label">생년월일</label>
                <div class="col-sm-9 controls">
                    <div class="row">
                        <div class="col-xs-4"><input type="text" value="${memberInfo.mem_birth }" id="mem_birth" name="mem_birth" placeholder="0000-00-00" class="form-control"/></div>
                    </div>
                </div>
            </div>
            <div class="form-group"><label class="col-sm-3 control-label">전화번호</label>
                <div class="col-sm-9 controls">
                    <div class="row">
                        <div class="col-xs-9"><input type="text" value="${memberInfo.mem_tel }" id="mem_tel" name="mem_tel" placeholder="000-0000-0000" class="form-control"/></div>
                    </div>
                </div>
            </div>
             <div class="form-group"><label class="col-sm-3 control-label">우편번호</label>
                <div class="col-sm-9 controls">
                    <div class="row">
                        <div class="col-xs-4"><input type="text" name="mem_zip" value="${memberInfo.mem_zip }" id="mem_zip" class="form-control"/></div>
		                <div class="col-md-3">
            ...
            <div class="form-group"><label class="col-sm-3 control-label">주소</label>
                <div class="col-sm-9 controls">
                    <div class="row">
                        <div class="col-xs-9"><input type="text" value="${memberInfo.mem_addr1 }" name="mem_addr1" id="mem_addr1" class="form-control"/></div>
                    </div>
                </div>
            </div>
            <div class="form-group"><label class="col-sm-3 control-label">상세 주소</label>
                <div class="col-sm-9 controls">
                    <div class="row">
                        <div class="col-xs-9"><input type="text" value="${memberInfo.mem_addr2 }" name="mem_addr2" id="mem_addr2" class="form-control"/></div>
                    </div>
                </div>
            </div>
            <hr/>
