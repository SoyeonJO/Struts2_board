...
<body>
	<div class="panel panel-green">
		...
		<form action="${pageContext.request.contextPath}/user/freeboard/insertfreeboardInfo.do"  id ="regibtn"  method="POST"  enctype="multipart/form-data">
				<div class="form-body pal">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">

								<input type="hidden" name="bo_mem_id" value="${LOGIN_MEMBERINFO.mem_id}"></input> 
             ...
             <div class="form-group"> 
	           <div class="col-md-7">
				...
				<div class="form-group">
						...
						<div class="input-icon right">
							<i class="fa fa-tag"></i> <input id="bo_title" name ="bo_title"  type="text"  class="form-control" />
						</div>
				</div>
				<div class="form-group">
