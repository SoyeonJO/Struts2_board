...
<body>
	<div class="panel panel-black" style="background: #fff;">
		...
		<div class="panel-body pan">
			<form
				action="${pageContext.request.contextPath}/user/reference/insertRef.do"
				method="post" id="rView" enctype="multipart/form-data">
				<div class="form-body pal">
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								<input id="ref_no" name="ref_no" type="hidden" placeholder=""
									class="form-control" /> <label for="inputSubject"
									class="control-label">제목</label>

								<div class="input-icon right">
									<input id="ref_title" name="ref_title" type="text"
										placeholder="" class="form-control"
										value="${refInfo.ref_title }" />
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								...
								<div class="input-icon right">
									<input readonly id="ref_nickname" name="ref_nickname"
										type="text" placeholder="" class="form-control"
										value="${LOGIN_MEMBERINFO.mem_name}" />
								</div>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<textarea id="ref_content" name="ref_content" rows="5"
							class="form-control" value="${refInfo.ref_content }"></textarea>
					</div>
				</div>
				<div class="form-group">
