package kr.or.ddit.admin.thumbnailitem.service;

import java.sql.SQLException;
import java.util.List;
import java.util.Map;

import kr.or.ddit.admin.thumbnailitem.dao.IThumbnailItemDao;
import kr.or.ddit.admin.thumbnailitem.dao.IThumbnailItemDaoImpl;
