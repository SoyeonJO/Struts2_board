...
<!-- 
	...
	파일 업로드 환경
	1. http://commons.apache.org -> FileUpload -> FileUpload 1.2.2 - 29 July 2010 -> binaries/ -> commons-fileupload-1.2.2-bin.zip
	                                IO -> Commons IO 2.3 (requires JDK 1.6+) -> commons-io-2.6-bin.zip
	commons-fileupload-1.2.2.jar
	commons-io-2.6.jar          
	2. WEB-INF / web import
 -->
<%
...
<!-- 
	form 태그 enctype="application/x-www-form-urlencoded" 
	                  일반 서브밋 요청(쿼리스트링의 값은 문자열)
	          enctyep="multipart/form-data"
