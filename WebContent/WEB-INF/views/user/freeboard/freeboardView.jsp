...
<body>
	<div class="panel panel-green">
		...
		<div class="panel-body pan">
			...
			<form
				action="${pageContext.request.contextPath}/user/freeboard/updatefreeboardInfo.do"
				id="freeboardView" role="form" method="post">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input id="bo_no" type="hidden" name="bo_no"
									class="form-control" /> <input type="hidden" id="bo_group"
									name="bo_group" /> <label for="inputName"
									class="control-label" for="bo_mem_id"> Name</label>
  ...
  $('#bo_group').val('${freeboardInfo.bo_group}');	
	...
	$('#freeboardView').submit(function(){	 
		var flag = redirectFlag();
		 if(flag){
			$(location).attr('href', '${pageContext.request.contextPath}/user/freeboard/updatefreeboardInfo.do');
		 }else{
	...
	$('#deletebtn').click(function(){
		var flag = redirectFlag();
    	 ...
    	 if(flag){
    			$(location).attr('href', '${pageContext.request.contextPath}/user/freeboard/deletefreeboardInfo.do?bo_no='+bo_no+'&bo_group='+bo_group);
    	 }else{
