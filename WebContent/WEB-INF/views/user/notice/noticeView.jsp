...
<div class="panel panel-black" style="background:#fff;">
   <div class="panel-heading">공지사항</div>
        <div class="panel-body pan">
             <form action="${pageContext.request.contextPath}/user/notice/updateNoticeInfo.do" role="form" method="post" id="noticeView">		
...
// 			$(location).attr('href', '${pageContext.request.contextPath}/user/notice/noticeList.do');
   ...
   // 삭제버튼
	$('#deletebtn').click(function(){
			...
			$(location).attr('href', '${pageContext.request.contextPath}/user/notice/deleteNoticeInfo.do?notice_no=${noticeInfo.notice_no}');
