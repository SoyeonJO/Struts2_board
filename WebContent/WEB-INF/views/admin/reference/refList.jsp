...
<script type='text/javascript'>
		$(function() {
			$('tbody tr').click(function() {
				...
				var url = '${pageContext.request.contextPath}/admin/reference/refView.do';
			...
			$('#insertBtn').click(function(){
					$(location).attr('href', '${pageContext.request.contextPath }/admin/reference/refForm.do');
			});
		});
</script>
</head>
...
<div >
<form action="${pageContext.request.contextPath }/admin/reference/refList.do" method="post" class="form-inline pull-right">
