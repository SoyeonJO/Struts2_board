...
$(function(){
	...
	$('#list').click(function(){
		if(eval('${!empty param.currentPage}')){
			$(location).attr('href', '${pageContext.request.contextPath}/admin/reference/refList.do?currentPage=${param.currentPage}&search_keyword=${param.search_keyword}&search_keycode=${param.search_keycode}');
		}else{
			$(location).attr('href', '${pageContext.request.contextPath}/admin/reference/refList.do?search_keyword=${param.search_keyword}&search_keycode=${param.search_keycode}');
		}
	}); 
   // 삭제버튼
	$('#deletebtn').click(function(){
		...
		var flag = redirectFlag();
			if(flag){
				$(location).attr('href', '${pageContext.request.contextPath}/admin/reference/deleteRef.do?ref_no=${refInfo.ref_no}');
			}
			else{
    ...
    $('#replybtn').click(function(){
    	...
    	var url = '${pageContext.request.contextPath}/admin/reference/refReply.do';
...
<div class="panel panel-black" style="background:#fff;">
   <div class="panel-heading">자료실 상세</div>
        <div class="panel-body pan">
             <form action="${pageContext.request.contextPath}/admin/reference/updateRef.do" method="post" id="rView">		
